...
class ChecklistsControllerTest < ActionController::TestCase
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post :create, checklist: { description: @checklist.description, name: @checklist.name, private: @checklist.private }
    end
  ...
  test "should update checklist" do
    put :update, id: @checklist, checklist: { description: @checklist.description, name: @checklist.name, private: @checklist.private }
    assert_redirected_to checklist_path(assigns(:checklist))
  end
